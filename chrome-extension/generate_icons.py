#!/usr/bin/env python3
"""
Icon generator for Medicine Cabinet Chrome Extension
Creates pill-shaped icons in all required sizes
"""
...
print("\n💊 Generating Medicine Cabinet icons for Chrome...")
print("=" * 50)
...
print("\n✅ All Chrome icons generated successfully!")
print(f"📁 Icons saved to: {OUTPUT_DIR}/")
print("\nExtension is ready to load in Chrome!")
print("Go to chrome://extensions/ → Load unpacked")
